...
local modelL1path = paths.concat('models', 'modelL1_4.t7')
local modelL2path = paths.concat('models', 'modelL2_4.t7')
local modelL3path = paths.concat('models', 'modelL3_4.t7')
local modelL4path = paths.concat('models', 'modelL4_4.t7')
...
local model = nn.gModule({im5},{_flow1, _flow2, _flow3, _flow4, _flow5}):cuda()
